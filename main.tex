...
\item Built a traceable SysML model linking mission requirements, UAV architecture, operating behavior, and performance equations; evaluated 3 delivery scenarios against various range, battery, and payload requirements.
\resumeItemListEnd
