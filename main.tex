...
\resumeItemListStart
\item Developed an executable SysML mobility subsystem linking torque, traction, speed, power, and climb constraints, then evaluated 30+ parametric cases to establish feasible performance limits.
\item Built a traceable SysML model linking mission requirements, UAV architecture, operating behavior, and performance equations; evaluated 3 delivery scenarios against 10 km range, 40-minute battery, and 2 kg payload requirements.
\resumeItemListEnd
...
\item Integrated CFD and FEA across 6 operating conditions, linking aerodynamic loads to blade stress and deformation while validating root radial force within 0.1\% of hand calculations.
